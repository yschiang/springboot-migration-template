...
- `ai/skills/springboot_reviewer/SKILL.md` (generic baseline)
- `ai/skills/springboot_migration/reviewer.md` (SB2→3 specific)
...
| Task | Skill |
|---|---|
| Spring Boot 2 to 3 migration fixes | `ai/skills/springboot_migration/SKILL.md` |
